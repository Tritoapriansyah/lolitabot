    ...
    try {
        if (m.mentionedJid.includes(this.user.jid) && m.isGroup) {
            await this.send2Button(m.chat,
                isBanned ? 'Fernazer tidak aktif' : banned ? 'kamu dibanned' : 'Fernazer Disini Knpa Tag Saya Kak?',
                '© Fernazer',
...
`.trim(), '© Fernazer', 'PEMILIK BOT', '.owner', { contextInfo: { mentionedJid: [global.owner[0] + '@s.whatsapp.net'] } })
    }
